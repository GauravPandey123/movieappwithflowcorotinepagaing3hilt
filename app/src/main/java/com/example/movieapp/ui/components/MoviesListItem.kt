...
import com.example.movieapp.utils.conditional
import com.example.movieapp.utils.items
...
fun MovieListItem(
    ...
    @Composable
    fun SelectableGenreChip(selected: Boolean, genre: String, onclick: () -> Unit) {
